...
if __name__ == "__main__":
    ...
    answer = rag_agent.run("What is the price of 32 inch smart tv?")
    print("\nFinal Answer:\n", answer)
    
    # Access the checkpointer
    memory = rag_agent.checkpointer
    
    for node, output in memory.storage["default_thread"].items():
        print(f"Node: {node}")
        print("Output:", output)
        print("---")
